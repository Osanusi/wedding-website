...
- Verify that if its done in the mobile app or webapp, it should be done in the other - don't create one-off solutions. If it already exists, re-use the same strategy. If it doesn't exist, build it for both.
...
- Point at logs,
  errors, failing tests - then resolve them
